...
class LiveApp:
    ...
    def run(self) -> int:
        if self.classifier is None:
            ...
            print(f"Run  python -m signsense.collect{hand_flag}  to record some signs, then")
            print(f"     python -m signsense.train{hand_flag}    to train the classifier.")
            return 1
...
def main() -> int:
    ...
    parser.add_argument("--two-hand", action="store_true", help="Recognize two-handed signs")
